...
<body>
    ...
    <form method="post" action="profile.php">
        ...
        Nová adresa (riadok 1): <input type="text" name="new_address_line1" value="<?php echo $currentAddressLine1; ?>"><br>
        Nová adresa (riadok 2): <input type="text" name="new_address_line2" value="<?php echo $currentAddressLine2; ?>"><br>
