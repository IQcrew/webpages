...
<head>
    ...
    <title>Vetvenie (podmienky)</title>
</head>
<body>
...
<div id="container">
    ...
    <div id="content">
        <h1 class="animate__fadeInDown animate__animated">Vetvenie (podmienky)</h1>
        ...
        <div id="content">
        <h1 class="animate__fadeInDown animate__animated">Kolekcie (Pole a Zoznamy)</h1>
